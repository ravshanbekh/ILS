    ...
    <div className="min-h-screen bg-zinc-950">
      ...
      <div className="p-8 max-w-6xl mx-auto space-y-6">
        <div className="flex flex-wrap items-center gap-2">
          <select value={typeFilter} onChange={(e) => setTypeFilter(e.target.value)} className="bg-zinc-900 border border-zinc-800 rounded-lg px-3 py-2 text-sm text-white">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <input type="date" value={fromDate} onChange={(e) => setFromDate(e.target.value)} className="bg-zinc-900 border border-zinc-800 rounded-lg px-2.5 py-2 text-xs text-white" />
            <span className="text-zinc-600 text-xs">—</span>
            <input type="date" value={toDate} onChange={(e) => setToDate(e.target.value)} className="bg-zinc-900 border border-zinc-800 rounded-lg px-2.5 py-2 text-xs text-white" />
            {(fromDate || toDate) && (
          ...
          <button
            ...
            disabled={exporting}
            className="ml-auto bg-zinc-900 hover:bg-zinc-800 text-zinc-300 px-4 py-2 rounded-lg text-sm font-medium border border-zinc-800 flex items-center gap-2 disabled:opacity-50"
          >
