      ...
      <div className="p-4 sm:p-8 max-w-5xl mx-auto">
        ...
        {normatives.length === 0 ? (
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl overflow-hidden">
            {/* Table Header */}
            <div className="hidden sm:grid grid-cols-[auto_1fr_100px_120px_100px] items-center gap-4 px-5 py-3 border-b border-zinc-800 bg-zinc-900">
                  ...
                  <div key={norm.id} className="group">
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3 sm:block">
                        <div className="w-10 h-10 rounded-lg bg-zinc-950 border border-zinc-800 flex items-center justify-center text-blue-500 font-bold text-xs shrink-0">
                          #{norm.taskNumber}
                        </div>
                        {/* Mobile title */}
                    ...
                    {/* Expanded Content */}
                    {isExpanded && (
                      <div className="px-5 pb-5 bg-zinc-900/50 border-t border-zinc-800/30 animate-fade-in">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-zinc-950 border border-zinc-800 text-white text-sm focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors"
                  required
                />
              </div>
              ...
              <div className="flex items-center gap-3 pt-2">
                <button
                  ...
                  className="flex-1 py-2.5 px-4 rounded-xl bg-zinc-950 hover:bg-zinc-800 text-zinc-300 font-medium text-sm transition-colors border border-zinc-800"
                >
                  Bekor qilish
                </button>
                <button
